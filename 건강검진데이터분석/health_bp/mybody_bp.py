...
def body():
    if request.method == 'GET':
        ...
        # 복부비만 판별
            ...
            if user_info[5] == 1:
                return render_template('my_body_res.html', age_list = male,age=str(age),height_list=M_height,weight_list=M_weight, gender=gender, b=b,c=c,d=d,x=x,MW=MW,MW_E_L=MW_E_L,MW_E_R=MW_E_R,SL=SL,SR=SR,
                ...
                return render_template('my_body_res.html', age_list = female,age=str(age),height_list=W_height, weight_list=W_weight, gender=gender, b=b,c=c,d=d,x=x,MW=MW,MW_E_L=MW_E_L,MW_E_R=MW_E_R,SL=SL,SR=SR,
                                    avg_height=avg_height,avg_BMI=avg_BMI,avg_weight=avg_weight, bmi=bmi,bmi_category=bmi_category,percentile=percentile,bmi_list=M_W_BMI,
